...
package day15.heartBeat.upload;
...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    static {
        DiskFileUpload.deleteOnExitTemporaryFile = true; // should delete file
                                                         // on exit (in normal
        DiskFileUpload.baseDirectory = "E:" + File.separatorChar + "软件相关"+File.separator+"视频教程"; // system temp directory
        DiskAttribute.deleteOnExitTemporaryFile = true; // should delete file on
                                                        // exit (in normal exit)
        DiskAttribute.baseDirectory = "E:" + File.separatorChar + "软件相关"+File.separator+"视频教程"; // system temp directory
    }
